...
A **Camada de Cluster** é composta por nós (3 ou mais, é recomendado um número ímpar) que realizam operações de acordo com . Esse protocolo é um algoritmo de consenso desenvolvido  da RavenDB (chamado de Consenso *Rachis*, uma implementação derivada do protocolo Raft) define um nó líder responsável por escolher o melhor nó para um determinado cliente, dando preferência a consistência das operações. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzIwNzM2ODU2LDE1NDkxMDk1NjUsMTQ2OD
